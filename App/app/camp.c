...
static const CAMP_Segment_t campMarineSegments[] = {
    {"SEA 16",  15680000, 15680000, STEP_25kHz, MODULATION_FM, BANDWIDTH_NARROW},
    {"SEA SHP", 15600000, 15742500, STEP_25kHz, MODULATION_FM, BANDWIDTH_NARROW},
    {"SEA CST", 16060000, 16195000, STEP_25kHz, MODULATION_FM, BANDWIDTH_NARROW},
    {"SEA ALL", 15600000, 16195000, STEP_25kHz, MODULATION_FM, BANDWIDTH_NARROW},
};
...
{
    return campActiveService == service;
}
...
{
    if (campActiveService == CAMP_SERVICE_AIR)
        return "AIR";
    if (campActiveService == CAMP_SERVICE_MARINE)
        return "SEA";
    return "";
}
...
{
    return campActiveSegment ? campActiveSegment->modulation : MODULATION_FM;
}
